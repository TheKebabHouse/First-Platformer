...
function pageLoad() {
    ...
    images.background = document.querySelector("#background") as HTMLImageElement;
    images.foreground = document.querySelector("#foreground") as HTMLImageElement;
    images.bushes = document.querySelector("#bushes") as HTMLImageElement;
